...
export default function Hero() {
  const line1 = "Residential Investment.";
  const line2 = "Commercial Returns.";
  ...
  return (
    <section className="relative w-full h-screen min-h-[1150px] flex items-center overflow-hidden bg-white select-none">
      ...
      <div className="absolute inset-0 z-0">
        <Image
          src="/assets/pojetcts/bizcore_image.webp"
          alt="Jhamtani Bizcore - Serviced Studio Apartments in Koregaon Park NX, Pune"
          fill
          priority
          quality={100}

...
const galleryItems = [
  ...
  },
  {
    ...
    title: "Jhamtani Bizcore - Site Progress 2",
  },
  {
    id: 3,
    image: "/assets/jhamtani-bizcore/site3.jpeg",
    title: "Jhamtani Bizcore - Site Progress 3",
  },
  {
    id: 4,
    image: "/assets/jhamtani-bizcore/site4.jpeg",
    title: "Jhamtani Bizcore - Site Progress 4",
  },
];
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="max-w-3xl text-left mb-16 lg:mb-30">
          ...
          <motion.p
            ...
            className="font-sans text-[12px] sm:text-[13px] text-zinc-300 font-light tracking-[0.1em] mt-4 leading-none uppercase"
          >
          ...
          <motion.p
            ...
            className="font-sans text-[14px] sm:text-[15px] text-zinc-400 leading-relaxed font-light mt-3 max-w-xl"
          >
            Explore the latest construction updates and milestones from Jhamtani BizCore.
          </motion.p>
          ...
          <button
            onClick={() => {
              const event = new CustomEvent("open-enquiry", {
                detail: { project: "Jhamtani Bizcore (Gallery)" },
              });

    ...
    if (validateForm()) {
      ...
      try {
        await submitMainEnquiryForm({
          ...
          formName: "Jhamtani BizCore Contact Form",
        });
      } catch (err) {
        console.error("Jhamtani BizCore submission error:", err);
      } finally {
    ...
    <section id="contact" className="relative w-full bg-[#EEEBE7] py-20 lg:py-28 px-6 sm:px-12 lg:px-16 text-zinc-900 select-none overflow-hidden">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="max-w-3xl text-left mb-16">
          ...
          >
            Understand the BizCore Opportunity
          </motion.h2>
          ...
          >
            Explore current availability, investment details and the serviced-studio format at Jhamtani BizCore. Our team will help you understand the project and identify an option aligned with your investment plans.
          </motion.p>
        </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8">
              ...
              <div className="flex flex-col space-y-2">
                ...
                >
                  ...
                  <option value="Serviced Studio Suite" className="text-white">Serviced Studio Suite</option>
                  <option value="1 BHK Smart Work-Live Suite" className="text-white">1 BHK Smart Work-Live Suite</option>
                  <option value="Boutique Office Suite" className="text-white">Boutique Office Suite</option>
                  <option value="Commercial Retail Space" className="text-white">Commercial Retail Space</option>
                </select>
                {errors.config && (
                  <span className="text-red-400 text-xs font-sans tracking-wide">
                    {errors.config}
        ...
        {/* Visit Jhamtani Bizcore & Logo Section */}
        <div className="mt-15 border-t border-zinc-300/40 flex flex-col md:flex-row items-center md:items-start md:justify-between gap-12 md:gap-6">
          ...
          <div className="flex flex-col text-left space-y-6 max-w-xl w-full">
            ...
            <div className="flex items-start gap-4 pt-2">
              <img
                src="/assets/jhamtani-bizcore/rera.webp"
          ...
          <div className="shrink-0 flex items-center justify-center md:justify-center w-full md:w-auto mt-4 md:mt-0">
            <img
              ...
              className="w-auto h-24 sm:h-28 md:h-30 object-contain mix-blend-multiply"
            />
          </div>
        </div>
      </div>
          ...
          >
            ...
            >
              ...
              <p className="font-sans text-sm text-zinc-400 leading-relaxed font-light mb-6">
                Thank you for your interest in Jhamtani Bizcore. Our dedicated relationship manager will get in touch with you shortly.
              </p>

...
export default function Hero() {
  const line1 = " A Private World,";
  const line2 = "Entirely Your Own.";
  ...
  return (
    <section className="relative w-full h-screen min-h-[900px] flex items-center overflow-hidden bg-white select-none">
      ...
      <div className="absolute inset-0 z-0">
        <Image
          src="/assets/pojetcts/ace_villas.webp"
          alt="ACE Villas - The Ideal Way of Living"
          fill
          priority
          quality={100}
        ...
        />
        {/* Elegant black gradient overlays for high text contrast and readability */}
      ...
      <div className="relative z-10 max-w-7xl mx-auto w-full px-6 sm:px-12 lg:px-16 flex justify-start items-start h-full pt-[26vh]">
        ...
        >
          <h1 className="font-serif font-normal text-[36px] sm:text-[48px] md:text-[54px] lg:text-[62px] leading-[1.1] text-white drop-shadow-[0_2px_15px_rgba(0,0,0,0.6)] tracking-wide">
            {/* Line 1 */}

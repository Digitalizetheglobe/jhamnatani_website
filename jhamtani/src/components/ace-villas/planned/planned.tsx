  ...
  return (
    <section className="relative w-full bg-[#191F26] text-white overflow-hidden flex flex-col lg:flex-row items-stretch min-h-[600px] lg:min-h-[700px] py-15 select-none">
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-end">
        <div className="w-full max-w-[680px] px-6 sm:px-12 lg:pl-16 lg:pr-12 py-16 lg:py-24 flex flex-col justify-center h-full">
          <div className="flex flex-col select-none">
            ...
            <p className="font-sans text-sm sm:text-[15px] text-zinc-400 leading-relaxed max-w-md font-light mt-8 lg:mt-10">
              Part of Jhamtani’s XO Signature Series, Ace Villas brings together three-side-open architecture, double-height interiors and private amenities within a discreet Koregaon Park NX address.
            </p>

            {/* Premium Action Buttons */}
            <div className="flex flex-wrap items-center gap-3 sm:gap-4 mt-20 lg:mt-32">
              <button className="border border-[#A0725B] text-zinc-300 hover:text-white rounded-full px-3 py-1.5 text-xs sm:text-sm tracking-wide bg-transparent cursor-pointer font-medium transition-all duration-300 hover:shadow-[0_0_15px_rgba(197,168,128,0.15)]">
                Download Brochure
              </button>
              <button className="border border-[#A0725B] text-zinc-300 hover:text-white rounded-full px-3 py-1.5 text-xs sm:text-sm tracking-wide bg-transparent cursor-pointer font-medium transition-all duration-300 hover:shadow-[0_0_15px_rgba(197,168,128,0.15)]">
                Get Cost Sheet

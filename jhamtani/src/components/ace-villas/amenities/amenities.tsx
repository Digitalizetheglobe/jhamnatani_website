...
const allAmenities = [
  // Row 1
  { id: 1, name: "Private Pool Deck", icon: "swimming-pool" },
  { id: 2, name: "Zen Garden", icon: "zen-garden" },
  { id: 3, name: "Signature Lounge", icon: "lounge" },
  { id: 4, name: "Fitness Studio", icon: "ac-gym" },
  { id: 5, name: "Children's Play Haven", icon: "childrens-play-area" },
  { id: 6, name: "Acupressure Pathway", icon: "acupressure-pathway" },
  // Row 2
  { id: 7, name: "Recreational Pavilion", icon: "recreational-hall" },
  { id: 8, name: "Kids Pool", icon: "kids-pool" },
  { id: 9, name: "Amphitheater", icon: "amphitheater" },
  { id: 10, name: "Activity Lawns", icon: "activity-lawns" },
  { id: 11, name: "Outdoor Gym", icon: "outdoor-gym" },
  { id: 12, name: "Aerial Yoga Deck", icon: "aerial-yog" },
  // Row 3
  { id: 13, name: "Wellness Spa", icon: "wellness-area" },
  { id: 14, name: "Zumba & Aerobics", icon: "zumba-aerobics-area" },
  { id: 15, name: "Open Cafeteria", icon: "open-cafeteria" },
  { id: 16, name: "Indoor Games Hub", icon: "indoor-games" },
  { id: 17, name: "Poker & Billiards", icon: "poker" },
  { id: 18, name: "Video Game Zone", icon: "video-game-zone" },
  // Row 4
  { id: 19, name: "Pool Table", icon: "pool-table" },
  { id: 20, name: "Table Tennis", icon: "table-tennis" },
  { id: 21, name: "Private Seating Cabana", icon: "seating-area" },
  { id: 22, name: "Squash Court", icon: "squash-court" },
  { id: 23, name: "Multipurpose Sports Court", icon: "multipurpose-court" },
  { id: 24, name: "Golf Simulator", icon: "golf-simulator" },
];

export default function Amenities() {
  const [isExpanded, setIsExpanded] = useState(false);

  // Show only 12 items on initial load (2 full rows), show all on expansion
    ...
    <section id="amenities" className="relative w-full bg-[#FFFFFF] py-20 lg:py-28 px-6 sm:px-12 lg:px-16 text-zinc-900 select-none overflow-hidden">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="max-w-3xl text-left mb-16 lg:mb-24">
          ...
          >
            Every villa comes with experiences created solely for you—offering space for quiet retreat, private leisure and intimate gatherings.
          </motion.p>
        </div>

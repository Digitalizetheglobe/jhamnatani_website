    ...
    if (validateForm()) {
      ...
      try {
        await submitMainEnquiryForm({
          ...
          formName: "Jhamtani Elevate Contact Form",
        });
      } catch (err) {
        console.error("Jhamtani Elevate submission error:", err);
      } finally {
    ...
    <section id="contact" className="relative w-full bg-[#EEEBE7] py-20 lg:py-28 px-6 sm:px-12 lg:px-16 text-zinc-900 select-none overflow-hidden">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="max-w-3xl text-left mb-16">
          ...
          >
            Discover current availability, studio plans and pricing at Jhamtani Elevate. Our team will help you understand the project and identify an option aligned with your ownership plans.
          </motion.p>
        </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8">
              ...
              <div className="flex flex-col space-y-2">
                ...
                >
                  ...
                  <option value="Studio Living Suite" className="text-white">Studio Living Suite</option>
                  <option value="1 BHK Smart Living" className="text-white">1 BHK Smart Living</option>
                  <option value="Work-Live Space" className="text-white">Work-Live Space</option>
                  <option value="2 BHK Residence" className="text-white">2 BHK Residence</option>
                </select>
                {errors.config && (
                  <span className="text-red-400 text-xs font-sans tracking-wide">
                    {errors.config}
        ...
        {/* Visit Jhamtani Elevate & Logo Section */}
        <div className="mt-15 border-t border-zinc-300/40 flex flex-col md:flex-row items-center md:items-start md:justify-between gap-12 md:gap-6">
          ...
          <div className="flex flex-col text-left space-y-6 max-w-xl w-full">
            ...
            <div className="space-y-3 font-sans text-sm text-zinc-700 leading-relaxed font-light">
              <p>
                ...
                Jadhav Nagar, Mundhwa, Pune – 411036
              </p>
              <p>
            ...
            <div className="flex items-start gap-4 pt-2">
              <img
                src="/assets/jhamtani-elevate/rera.webp"
          ...
          <div className="shrink-0 flex items-center justify-center md:justify-center w-full md:w-auto mt-4 md:mt-0">
            <img
              src="/assets/pojetcts/Elevate logo.webp"
              alt="Jhamtani Elevate Logo"
              className="w-auto h-24 sm:h-28 md:h-35 object-contain mix-blend-multiply"
            />
          </div>
        </div>
      </div>
          ...
          >
            ...
            >
              ...
              <p className="font-sans text-sm text-zinc-400 leading-relaxed font-light mb-6">
                Thank you for your interest in Jhamtani Elevate. Our dedicated relationship manager will get in touch with you shortly.
              </p>

...
const PROJECT_COORDS: [number, number] = [18.5362, 73.9259];
    ...
    items: [
      {
        ...
        lat: 18.5375,
        lng: 73.8965,
        query: "Kopa Mall, Koregaon Park, Pune",
      },
      {
        name: "Westin Hotel",
        distance: "1.9 km",
  ...
  useEffect(() => {
    async function updateMapMarkers() {
      ...
      if (!selectedItem) {
        ...
        // Draw clean connecting line between Jhamtani Elevate and selected location
    ...
    <section className="relative w-full bg-[#191F26] pt-20 select-none overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto mb-20 px-6 sm:px-12 lg:px-16">
        <div className="max-w-3xl text-left">
          ...
          >
            Jhamtani Elevate keeps IT parks, premium shopping avenues, upscale destinations in Koregaon Park, transit and everyday essentials comfortably within reach.
          </motion.p>
        </div>
      </div>
      ...
      <div className="relative w-full flex flex-col md:block">
        {/* Clean Interactive Leaflet Map (Zero Third-Party Business Ads/POIs) */}
            ...
            onClick={() => {
              if (!selectedItem) {
                const event = new CustomEvent("open-enquiry", {
                  detail: { project: "Jhamtani Elevate (Location)" },
                });

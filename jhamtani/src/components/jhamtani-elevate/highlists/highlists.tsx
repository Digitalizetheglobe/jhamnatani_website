...
const highlights = [
  {
    ...
    desc: "Fully furnished studios offer a compact, comfortable and convenient living experience.",
    image: "/assets/jhamtani-elevate/Built tall for those who think higher.webp",
    alt: "Built Tall for Those Who Think Higher - Jhamtani Elevate",
  },
  {
    id: 2,
    title: "Designed for a New Urban Lifestyle",
    desc: "Co-working, dining and community spaces extend life beyond the studio.",
    image: "/assets/jhamtani-elevate/Where work meets rest, seamlessly.webp",
    alt: "Where Work Meets Rest, Seamlessly - Jhamtani Elevate",
  },
  {
    id: 3,
    title: "Positioned for Everyday Convenience",
    desc: "A Mundhwa address keeps key business, lifestyle and social destinations within easy reach.",
    image: "/assets/jhamtani-elevate/Dine under the open sky.webp",
    alt: "Dine Under the Open Sky - Jhamtani Elevate",
  },
];
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="max-w-3xl text-left mb-16 lg:mb-20">
          ...
          <p className="font-sans text-[12px] sm:text-[13px] text-[#000] font-light tracking-[0.1em] mt-6 leading-none">
           Contemporary living, considered in full.
          </p>
          <p className="font-sans text-[14px] sm:text-[15px] text-[#000] leading-relaxed font-light mt-3 max-w-xl">
            Private studios, shared experiences and strong connectivity come together for a more flexible urban lifestyle.
          </p>
        </div>

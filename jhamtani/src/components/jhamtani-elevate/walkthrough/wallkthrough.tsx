    ...
    <section className="relative w-full bg-[#FFFFFF] py-20 lg:py-28 px-6 sm:px-12 lg:px-16 text-zinc-900 select-none overflow-hidden">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="max-w-3xl text-left mb-16 lg:mb-20">
          ...
          >
            Take a closer look at the studios and shared spaces created around modern work, living and community.
          </motion.p>
        </div>
        ...
        >
          {/* Preview Image */}
          <img
            src="/assets/projects/jhamtani-elevate.webp"
            alt="Project Walkthrough Video Preview - Jhamtani Elevate"

...
const galleryItems = [
  {
    ...
    title: "A Skyline Statement, Day and Night",
  },
  {
    id: 2,
    image: "/assets/ace-aster/designed-as-a-sanctuary-built-as-a-landmark.webp",
    title: "Designed as a Sanctuary, Built as a Landmark",
  },
  {
    id: 3,
    image: "/assets/ace-aster/where-the-city-looks-up.webp",
    title: "Where the City Looks Up",
  },
  {
    id: 4,
    image: "/assets/ace-aster/where-the-skyline-comes-alive.webp",
    title: "Where the Skyline Comes Alive",
  },
  {
    id: 5,
    image: "/assets/ace-aster/a-living-room-made-for-living.webp",
    title: "A Living Room Made for Living",
  },
  {
    id: 6,
    image: "/assets/ace-aster/a-space-that-brings-people-together.webp",
    title: "A Space That Brings People Together",
  },
  {
    id: 7,
    image: "/assets/ace-aster/a-personal-haven-of-comfort.webp",
    title: "A Personal Haven of Comfort",
  },
  {
    id: 8,
    image: "/assets/ace-aster/a-personal-haven-of-comfort-1.webp",
    title: "Thoughtfully Crafted Master Suites",
  },
  {
    id: 9,
    image: "/assets/ace-aster/cool-waters-calmer-days.webp",
    title: "Cool Waters, Calmer Days",
  },
  {
    id: 10,
    image: "/assets/ace-aster/calm-spaces-for-thoughtful-moments.webp",
    title: "Calm Spaces for Thoughtful Moments",
  },
  {
    id: 11,
    image: "/assets/ace-aster/crafted-for-meals-memories-and-more.webp",
    title: "Crafted for Meals, Memories, and More",
  },
  {
    id: 12,
    image: "/assets/ace-aster/fitness-that-feels-effortless.webp",
    title: "Fitness That Feels Effortless",
  },
  {
    id: 13,
    image: "/assets/ace-aster/modern-efficiency-refined-taste.webp",
    title: "Modern Efficiency, Refined Taste",
  },
  {
    id: 14,
    image: "/assets/ace-aster/moments-shared-beautifully.webp",
    title: "Moments Shared, Beautifully",
  },
  {
    id: 15,
    image: "/assets/ace-aster/where-evenings-unfold-beautifully.webp",
    title: "Where Evenings Unfold Beautifully",
  },
  {
    id: 16,
    image: "/assets/ace-aster/where-gatherings-feel-grand.webp",
    title: "Where Gatherings Feel Grand",
  },
  {
    id: 17,
    image: "/assets/ace-aster/where-private-comfort-meets-social-living.webp",
    title: "Where Private Comfort Meets Social Living",
  },
  {
    id: 18,
    image: "/assets/ace-aster/budget-3-bhk-apartment-at-ravet-1.webp",
    title: "Spacious 3 BHK Living Spaces",
  },
  {
    id: 19,
    image: "/assets/ace-aster/budget-3-bhk-apartment-at-ravet-6.webp",
    title: "Contemporary Bedroom Design",
  },
  {
    id: 20,
    image: "/assets/ace-aster/budget-3-bhk-apartment-at-ravet-7.webp",
    title: "Refined Interior Finishes",
  },
  {
    id: 21,
    image: "/assets/ace-aster/budget-3-bhk-apartment-at-ravet-8.webp",
    title: "Elegant Dining & Living Layout",
  },
  {
    id: 22,
    ...
    <section className="relative w-full bg-[#191F26] py-20 lg:py-28 px-6 sm:px-12 lg:px-16 text-white select-none overflow-hidden">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="max-w-3xl text-left mb-16 lg:mb-30">
          ...
          >
            A closer look at life at Ace Aster.
          </motion.p>
        </div>
          ...
          <button
            onClick={() => {
              const event = new CustomEvent("open-enquiry", {
                detail: { project: "ACE Aster (Gallery)" },
              });

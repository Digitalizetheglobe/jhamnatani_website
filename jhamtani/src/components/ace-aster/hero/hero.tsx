...
export default function Hero() {
  ...
  return (
    <section className="relative w-full h-screen min-h-[850px] flex items-center overflow-hidden bg-white select-none">
      {/* Background Image Container */}
      <div className="absolute inset-0 z-0">
        <Image
          src="/assets/pojetcts/ace_aster.webp"
          alt="Ace Aster - Contemporary Luxury Living in Ravet"
          fill
          priority
          quality={100}

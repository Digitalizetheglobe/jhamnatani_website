...
const PROJECT_COORDS: [number, number] = [18.6580, 73.7243];

const locationsData: LocationGroup[] = [
  {
    category: "Within 5 mins",
    items: [
      {
        ...
        lat: 18.6535,
        lng: 73.7385,
        query: "Symbiosis Skills and Professional University, Kiwale, Pune",
      },
      {
        name: "Mumbai–Bangalore Expressway",
        distance: "1.5 km",
        time: "4 mins",
        lat: 18.665,
        lng: 73.728,
        query: "Mumbai Pune Expressway, Ravet, Pune",
      },
      {
        name: "D-Mart",
        distance: "3.0 km",
        ...
        lat: 18.6475,
        lng: 73.742,
        query: "DMart, Ravet, Pune",
      },
      {
        name: "S.B. Patil School & College",
        distance: "2.2 km",
        time: "5 mins",
        lat: 18.651,
        lng: 73.739,
        query: "S. B. Patil Public School, Ravet, Pune",
      },
    ],
  },
  {
    category: "Within 10 mins",
    items: [
      {
      ...
      },
      {
        ...
        lat: 18.5912,
        lng: 73.738,
        query: "Rajiv Gandhi Infotech Park, Hinjewadi, Pune",
      },
      {
        ...
        lat: 18.636,
        lng: 73.785,
        query: "Lokmanya Hospital, Chinchwad, Pune",
      },
    ],
  },
];
...
export default function MapSection() {
  const [expandedCategory, setExpandedCategory] = useState("Within 5 mins");
  ...
  useEffect(() => {
    async function updateMapMarkers() {
      ...
      if (!selectedItem) {
        ...
        // Draw clean connecting line between Ace Aster and selected location
    ...
    <section className="relative w-full bg-[#191F26] pt-20 select-none overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto mb-20 px-6 sm:px-12 lg:px-16">
        <div className="max-w-3xl text-left">
          ...
          >
            Located in Ravet, Ace Aster keeps education, healthcare, shopping and key employment destinations conveniently connected.
          </motion.p>
        </div>
      </div>
            ...
            onClick={() => {
              if (!selectedItem) {
                const event = new CustomEvent("open-enquiry", {
                  detail: { project: "ACE Aster (Location)" },
                });

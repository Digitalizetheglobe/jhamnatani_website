...
export default function Gallery() {
  const [activeIndex, setActiveIndex] = useState(1); // Set "Multipurpose Court" as active initially
  ...
  const getCardStyles = (idx: number) => {
    ...
    if (diff === 0) {
      ...
      return {
        ...
        y: isMobile ? 0 : 25,
        scale: 0.96,
        opacity: isMobile ? 0 : 1, // Keep container opacity at 1 so the image and text are visible
        zIndex: 10,

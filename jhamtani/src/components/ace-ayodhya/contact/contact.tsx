    ...
    if (validateForm()) {
      ...
      try {
        await submitMainEnquiryForm({
          ...
          formName: "ACE Ayodhya Contact Form",
        });
      } catch (err) {
        console.error("ACE Ayodhya submission error:", err);
      } finally {
    ...
    <section id="contact" className="relative w-full bg-[#EEEBE7] py-20 lg:py-28 px-6 sm:px-12 lg:px-16 text-zinc-900 select-none overflow-hidden">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="max-w-3xl text-left mb-16">
          ...
          >
            Explore available residences, floor plans and current pricing at Ace Ayodhya. Our team will help you identify the home that best suits your family and plans.
          </motion.p>
        </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8">
              ...
              <div className="flex flex-col space-y-2">
                ...
                >
                  ...
                  <option value="4 BHK" className="text-white">4 BHK Residences</option>
                  <option value="Duplex Penthouse" className="text-white">Duplex Penthouse</option>
                </select>
                {errors.config && (
                  <span className="text-red-400 text-xs font-sans tracking-wide">
                    {errors.config}
        ...
        {/* Visit Ace Ayodhya & Logo Section */}
        <div className="mt-15 border-t border-zinc-300/40 flex flex-col md:flex-row items-center md:items-start md:justify-between gap-12 md:gap-6">
          ...
          <div className="flex flex-col text-left space-y-6 max-w-xl w-full">
            ...
            <div className="flex items-start gap-4 pt-2">
              {/* RERA QR code image */}
              <img
                src="/assets/ace-ayodhya/rera.webp"
          ...
          >
            ...
            >
              ...
              <p className="font-sans text-sm text-zinc-400 leading-relaxed font-light mb-6">
                Thank you for your interest in Ace Ayodhya. Our dedicated relationship manager will get in touch with you shortly.
              </p>

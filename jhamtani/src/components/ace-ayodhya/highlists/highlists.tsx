...
const highlights = [
  {
    ...
    desc: "Well-proportioned homes designed around light, privacy and everyday ease.",
    image: "/assets/ace-ayodhya/highlight_1.webp",
    alt: "Purposeful Planning - Bedroom Interior",
  },
  {
    id: 2,
    title: "Private, Yet Connected",
    desc: "Personal spaces complemented by settings to meet, gather and belong.",
    image: "/assets/ace-ayodhya/highlight_2.webp",
    alt: "Private, Yet Connected - Outdoor Courtyard Garden",
  },
  {
    id: 3,
    title: "Well-Being, Built In",
    desc: "Wellness, recreation and leisure spaces designed for every generation.",
    image: "/assets/ace-ayodhya/highlight_3.webp",
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="max-w-3xl text-left mb-16 lg:mb-20">
          ...
          <p className="font-sans text-[12px] sm:text-[13px] text-[#000] font-light tracking-[0.1em] mt-6 leading-none">
            The essentials, considered in full.
          </p>
          <p className="font-sans text-[14px] sm:text-[15px] text-[#000] leading-relaxed font-light mt-3 max-w-xl">
            Thoughtful planning, personal privacy and well-being come together to shape a more balanced way of living.
          </p>
        </div>

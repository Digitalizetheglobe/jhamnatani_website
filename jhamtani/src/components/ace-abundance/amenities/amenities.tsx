...
const allAmenities = [
  // Row 1
  { id: 1, name: "Multipurpose Hall", icon: "recreational-hall" },
  { id: 2, name: "Amphitheatre", icon: "amphitheater" },
  { id: 3, name: "Co-Working Space", icon: "lounge" },
  { id: 4, name: "Senior Citizen Area", icon: "seating-area" },
  { id: 5, name: "Board Room", icon: "lounge" },
  { id: 6, name: "Podcast Room", icon: "indoor-games" },
  // Row 2
  { id: 7, name: "Crèche Area", icon: "creche" },
  { id: 8, name: "Outdoor Movie Screening Wall", icon: "scribbling-wall" },
  { id: 9, name: "Boxing Area", icon: "outdoor-gym" },
  ...
  { id: 15, name: "Foosball Area", icon: "indoor-games" },
  ...
  { id: 22, name: "Bar Counter/Work Café", icon: "cafeteria" },
  { id: 23, name: "Terrace Café", icon: "open-cafeteria" },
  { id: 24, name: "Chess Play Area", icon: "indoor-games" },
  // Row 5
  { id: 25, name: "Air Hockey", icon: "pool-table" },
  { id: 26, name: "Cards Play Area", icon: "poker" },
  { id: 27, name: "Spa", icon: "wellness-area" },
  { id: 28, name: "Carrom Play Area", icon: "indoor-games" },
  { id: 29, name: "Outdoor Spa", icon: "wellness-area" },
  { id: 30, name: "Salt Room", icon: "zen-garden" },
  // Row 6
  { id: 31, name: "Thought Room & Library", icon: "lounge" },
  { id: 32, name: "Aerial Yoga", icon: "aerial-yog" },
  { id: 33, name: "Steam & Sauna", icon: "wellness-area" },
  { id: 34, name: "Children's Play Area - Sand Pit", icon: "sandpit" },
  { id: 35, name: "Active Play Area for Children", icon: "childrens-play-area" },

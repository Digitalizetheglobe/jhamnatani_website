      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-12 lg:px-24 space-y-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-start">
          ...
          <div className="lg:col-span-2 flex lg:justify-end justify-start">
            <button
              onClick={scrollToTop}
              className="w-16 h-16 rounded-full border border-[#C5A880]/60 hover:bg-[#C5A880] hover:border-[#C5A880] text-[#C5A880] hover:text-[#111622] flex items-center justify-center transition-all duration-300 cursor-pointer"
            >
              <svg className="w-6 h-6 stroke-[1.8]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">

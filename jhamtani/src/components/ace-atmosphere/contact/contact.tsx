    ...
    if (validateForm()) {
      ...
      try {
        await submitMainEnquiryForm({
          ...
          formName: "ACE Atmosphere Contact Form",
        });
      } catch (err) {
        console.error("ACE Atmosphere submission error:", err);
      } finally {
    ...
    <section id="contact" className="relative w-full bg-[#EEEBE7] py-20 lg:py-28 px-6 sm:px-12 lg:px-16 text-zinc-900 select-none overflow-hidden">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="max-w-3xl text-left mb-16">
          ...
          >
            Explore available residences, floor plans and current pricing at Ace Atmosphere. Our team will help you identify the home best suited to your family and lifestyle.
          </motion.p>
        </div>
        ...
        {/* Visit Ace Atmosphere & Logo Section */}
        <div className="mt-15 border-t border-zinc-300/40 flex flex-col md:flex-row items-center md:items-start md:justify-between gap-12 md:gap-6">
          ...
          <div className="flex flex-col text-left space-y-6 max-w-xl w-full">
            ...
            <div className="space-y-3 font-sans text-sm text-zinc-700 leading-relaxed font-light">
              <p>
                ...
                Survey No. 60(P) and 61(P), Near Mukai Chowk, Next to Bhondave Wasti Bus Stop, Aundh–Ravet BRTS Road, Ravet, Pune
              </p>
              <p>
            ...
            <div className="flex items-start gap-4 pt-2">
              {/* RERA QR code image */}
              <img
                src="/assets/ace-atmosphere/rera.webp"
          ...
          <div className="shrink-0 flex items-center justify-center md:justify-center w-full md:w-auto mt-4 md:mt-0">
            <img
              ...
              className="w-auto h-24 sm:h-28 md:h-44 object-contain mix-blend-multiply"
            />
          </div>
        </div>
      </div>
          ...
          >
            ...
            >
              ...
              <p className="font-sans text-sm text-zinc-400 leading-relaxed font-light mb-6">
                Thank you for your interest in Ace Atmosphere. Our dedicated relationship manager will get in touch with you shortly.
              </p>

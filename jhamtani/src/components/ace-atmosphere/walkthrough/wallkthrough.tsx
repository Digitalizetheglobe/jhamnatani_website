    ...
    <section className="relative w-full bg-[#FFFFFF] py-20 lg:py-28 px-6 sm:px-12 lg:px-16 text-zinc-900 select-none overflow-hidden">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="max-w-3xl text-left mb-16 lg:mb-20">
          ...
          >
            Take a closer look at the residences, landscaped spaces and elevated amenities that bring every aspect of the project together.
          </motion.p>
        </div>
        ...
        >
          {/* Preview Image */}
          <img
            src="/assets/projects/ace-atmosphere.webp"

...
const PROJECT_COORDS: [number, number] = [18.6562, 73.7352];
...
const locationsData: LocationGroup[] = [
  {
    ...
    items: [
      ...
      {
        name: "Mukai Chowk Bus Stop",
        distance: "1.2 km",
        time: "3 mins",
        lat: 18.659,
        lng: 73.741,
        query: "Mukai Chowk, Kiwale, Ravet, Pune",
      },
      {
        name: "Ravet Chowk Bus Stop",
        distance: "1.5 km",
        time: "4 mins",
        lat: 18.6505,
        lng: 73.7435,
        query: "Ravet Chowk, Ravet, Pune",
      },
    ],
  },
  {
    category: "Within 5 km",
    items: [
      {
        name: "S.B. Patil School",
        distance: "2.5 km",
        time: "6 mins",
        lat: 18.651,
        lng: 73.739,
      ...
      },
      {
        ...
        lat: 18.646,
        lng: 73.748,
        query: "Reliance Smart, Ravet, Pune",
      },
      {
        name: "D-Mart",
        distance: "3.8 km",
      ...
      },
      {
        ...
        lat: 18.6492,
        lng: 73.771,
        query: "Akurdi Railway Station, Pune",
      },
    ],
  },
  {
    category: "Within 10 km",
    items: [
      {
  ...
  useEffect(() => {
    async function updateMapMarkers() {
      ...
      if (!selectedItem) {
        ...
        // Draw clean connecting line between Ace Atmosphere and selected location
    ...
    <section className="relative w-full bg-[#191F26] pt-20 select-none overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto mb-20 px-6 sm:px-12 lg:px-16">
        <div className="max-w-3xl text-left">
          ...
          >
            Ace Atmosphere keeps daily conveniences, education, transit and lifestyle destinations comfortably within reach.
          </motion.p>
        </div>
      </div>
            ...
            onClick={() => {
              if (!selectedItem) {
                const event = new CustomEvent("open-enquiry", {
                  detail: { project: "Ace Atmosphere (Location)" },
                });

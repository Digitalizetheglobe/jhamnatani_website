...
export default function Hero() {
  const line1 = "Every Moment,";
  const line2 = "Well Lived.";
  ...
  return (
    <section className="relative w-full h-screen min-h-[950px] flex items-center overflow-hidden bg-white select-none">
      {/* Background Image Container */}
      <div className="absolute inset-0 z-0">
        <Image
          src="/assets/pojetcts/ace_atmosphere.webp"
          alt="Ace Atmosphere - Pune's 1st 24x7 Lifestyle Concept in Ravet"
          fill
          priority
          quality={100}

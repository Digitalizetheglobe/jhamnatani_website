...
export default function Contact() {
  ...
  return (
    <div id="contact" className="w-full flex flex-col bg-white">
      ...
      <section className="w-full bg-[#eeebe7] text-zinc-900 pt-8 sm:pt-10 lg:pt-16 pb-16 sm:pb-20 lg:pb-24">
        <div className="max-w-7xl mx-auto w-full px-6 sm:px-12 lg:px-16 space-y-8">
          {/* Header */}
          <motion.div

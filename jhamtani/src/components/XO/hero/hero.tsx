...
export default function Hero() {
  return (
    <section 
      className="relative w-full h-[115vh] min-h-[750px] sm:min-h-[950px] flex items-center justify-start px-6 sm:px-12 md:px-20 lg:px-32 overflow-hidden"
    >
      ...
      <div className="relative z-10 max-w-4xl text-left -translate-y-12 md:-translate-y-16">
        {/* Main Headline with Luxury Reveal Effect */}
        <h1 className="font-inria font-light text-[#A0725B] text-4xl sm:text-5xl md:text-6xl lg:text-[60px] leading-[1.1] tracking-wide mb-12 sm:mb-14 select-none">
          {/* Line 1 */}

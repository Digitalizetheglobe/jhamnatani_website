...
const galleryItems = [
  {
    ...
    title: "Designed for Brands, Built for Returns",
  },
  {
    id: 2,
    image: "/assets/jhamtani-spacebiz/image-2.webp",
    title: "Where Business Begins with Distinction",
  },
  {
    id: 3,
    image: "/assets/jhamtani-spacebiz/image-3.webp",
    title: "Your Daily Dose of Discipline",
  },
  {
    id: 4,
    image: "/assets/jhamtani-spacebiz/image-4.webp",
    title: "A Vertical Statement of Ambition",
  },
  {
    id: 5,
    image: "/assets/jhamtani-spacebiz/image-5.webp",
    title: "An Address for Those Who Think Higher",
  },
];
...
export default function Gallery() {
  ...
  const getCardStyles = (idx: number) => {
    ...
    if (signedDiff === 0) {
      ...
      // Hidden cards parked further away
      return {

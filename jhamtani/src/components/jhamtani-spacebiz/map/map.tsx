...
const PROJECT_COORDS: [number, number] = [18.5590, 73.7868];

const locationsData: LocationGroup[] = [
  {
    category: "Immediate Vicinity",
    items: [
      {
        name: "Metro Station",
        distance: "0.5 km",
        ...
        lat: 18.5580,
        lng: 73.7915,
        query: "Baner Metro Station, Pune",
      },
      {
        name: "Aundh",
        distance: "Within 5 mins",
        time: "5 mins",
        lat: 18.5615,
        lng: 73.8062,
        query: "Aundh, Pune",
  ...
  {
    category: "Key Hubs & Education",
    items: [
      {
        name: "Balewadi",
        distance: "Within 15 mins",
        time: "15 mins",
        lat: 18.5721,
        lng: 73.7745,
        query: "Balewadi, Pune",
      ...
      },
      {
        ...
        lat: 18.5530,
        lng: 73.8250,
        query: "Savitribai Phule Pune University, Pune",
      },
    ],
  },
  {
    category: "Transit Terminals",
    items: [
      {
        ...
        lat: 18.5284,
        lng: 73.8744,
        query: "Pune Junction Railway Station, Pune",
      },
      {
...
export default function MapSection() {
  const [expandedCategory, setExpandedCategory] = useState("Immediate Vicinity");
  ...
  useEffect(() => {
    async function updateMapMarkers() {
      ...
      if (!selectedItem) {
        ...
        // Draw clean connecting line between Jhamtani SpaceBiz and selected location
    ...
    <section className="relative w-full bg-[#191F26] pt-20 select-none overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto mb-20 px-6 sm:px-12 lg:px-16">
        <div className="max-w-3xl text-left">
          ...
          >
            Where Business Stays Connected.
          </motion.h2>
          ...
          >
            Positioned on Baner Road, SpaceBiz keeps prominent business districts, city neighbourhoods and major transit connections within easy reach.
          </motion.p>
        </div>
      </div>
            ...
            {selectedItem && (
              ...
              >
                ...
                <div className="flex items-end justify-between border-t border-white/10 pt-3">
                  <div>
                    <span className={`${
                      selectedItem.distance.length > 8
                        ? "text-[18px] sm:text-[20px]"
                        : "text-[26px] sm:text-[28px]"
                    } font-bold text-[#A0725B] leading-none font-sans`}>
            ...
            onClick={() => {
              if (!selectedItem) {
                const event = new CustomEvent("open-enquiry", {
                  detail: { project: "Jhamtani SpaceBiz (Location)" },
                });

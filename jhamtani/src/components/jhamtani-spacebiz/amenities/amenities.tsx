...
const allAmenities = [
  // Row 1
  { id: 1, name: "Grand Entrance Lobby", icon: "main-entrance-lobby", isElevateDir: true },
  { id: 2, name: "Co-Working Hub", icon: "co-working-space", isElevateDir: true },
  { id: 3, name: "Executive Meeting Rooms", icon: "society-office", isElevateDir: true },
  { id: 4, name: "Rooftop Cafeteria", icon: "dining-area", isElevateDir: true },
  { id: 5, name: "Business Lounge", icon: "seating-loose-furniture", isElevateDir: true },
  { id: 6, name: "Indoor Recreation", icon: "indoor-games", isElevateDir: true },

  // Row 2
  { id: 7, name: "Multi-Level Car Parking", icon: "drivers-room", isElevateDir: true },
  { id: 8, name: "High-Speed Elevators", icon: "entrance-passage", isElevateDir: true },
  { id: 9, name: "100% Power Backup", icon: "house-keeping", isElevateDir: true },
  { id: 10, name: "Terrace Garden & Lounge", icon: "terrace-herbal-garden", isElevateDir: true },
  { id: 11, name: "Multi-Tier 24/7 Security", icon: "linen-store", isElevateDir: true },
  { id: 12, name: "Open Breakout Lawns", icon: "edge-plantation", isElevateDir: true },

  // Row 3
  { id: 13, name: "Fitness & Wellness Gym", icon: "open-gym", isElevateDir: true },
  { id: 14, name: "Outdoor Event Seating", icon: "multipurpose-seating", isElevateDir: true },
  { id: 15, name: "Dedicated EV Charging", icon: "bbq-counter", isElevateDir: true },
  { id: 16, name: "Modern Restroom Facilities", icon: "toilet", isElevateDir: true },
  { id: 17, name: "Pantry & Dining Service", icon: "kitchen", isElevateDir: true },
];

export default function Amenities() {
  const [isExpanded, setIsExpanded] = useState(false);

  // Show 12 items on initial load, show all 17 on expansion
    ...
    <section id="amenities" className="relative w-full bg-[#FFFFFF] py-20 lg:py-28 px-6 sm:px-12 lg:px-16 text-zinc-900 select-none overflow-hidden">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="max-w-3xl text-left mb-16 lg:mb-24">
          ...
          >
            Curated Infrastructure for Productive Business & Leisure.
          </motion.p>
          ...
          >
            From high-speed elevators and expansive conference facilities to rooftop breakout zones and advanced security systems, elevate your business operations.
          </motion.p>
        </div>

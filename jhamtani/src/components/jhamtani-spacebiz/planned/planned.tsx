  ...
  const handleEnquiry = (action: string) => {
    const event = new CustomEvent("open-enquiry", {
      detail: {
        ...
        message: `I am interested in ${action} for Jhamtani SpaceBiz.`,
      },
    });
        ...
        <div className="w-full max-w-[640px] px-6 sm:px-12 lg:pl-16 lg:pr-12 py-16 lg:py-24 flex flex-col justify-center h-full">
          <div className="flex flex-col select-none">
            ...
            <p className="font-sans text-sm sm:text-[15px] text-zinc-400 leading-relaxed max-w-md font-light mt-8 lg:mt-10">
              Jhamtani SpaceBiz brings together 150-metre stature, exclusive offices and a seamless arrival experience at a prominent Baner address.
            </p>
            
            {/* Carpet Area Specification */}
            <div className="mt-6 flex items-center gap-2.5">
              <span className="text-[#A0725B] text-xs uppercase tracking-[0.15em] font-medium">
                Total Carpet Area :
              </span>
              <span className="text-white text-sm sm:text-[15px] font-semibold tracking-wide">
                3.36 lakh sq. ft.
              </span>
            </div>

            {/* Premium Action Buttons - Single Line */}
            <div className="flex items-center gap-2 sm:gap-3 lg:gap-3.5 mt-12 lg:mt-20 flex-nowrap overflow-x-auto lg:overflow-visible scrollbar-none">
              <button

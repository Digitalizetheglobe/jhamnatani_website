...
export default function Contact() {
  ...
  const handlePhoneChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    const value = e.target.value.replace(/\D/g, ""); // Keep only numeric digits
    if (value.length <= 10) {
    ...
    <section id="contact" className="relative w-full bg-[#EEEBE7] py-20 lg:py-28 px-6 sm:px-12 lg:px-16 text-zinc-900 select-none overflow-hidden">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="max-w-3xl text-left mb-16">
          ...
          >
            Position your business at SpaceBiz
          </motion.h2>
          ...
          >
            Explore available commercial spaces, plans and current pricing at Jhamtani SpaceBiz. Our team will help you identify a workspace aligned with your business requirements.
          </motion.p>
        </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8">
              ...
              <div className="flex flex-col space-y-2">
                ...
                >
                  ...
                  <option value="Executive Office Suites" className="text-white">Executive Office Suites</option>
                  <option value="Corporate Showrooms & Retail" className="text-white">Corporate Showrooms & Retail</option>
                  <option value="Customizable Floor Plates" className="text-white">Customizable Floor Plates</option>
                  <option value="Boutique Commercial Units" className="text-white">Boutique Commercial Units</option>
                </select>
                {errors.config && (
                  <span className="text-red-400 text-xs font-sans tracking-wide">
                    {errors.config}
            ...
            <div className="flex flex-col space-y-1.5 pt-2">
              <label className="flex items-start gap-3 cursor-pointer group">
                ...
                <span className="text-[12px] sm:text-[13px] text-zinc-400 font-light leading-snug tracking-wide select-none">
                  I authorize Jhamtani Group and its representatives to contact me via phone calls, SMS, WhatsApp, and email regarding project updates, commercial plans, and brochures.
                </span>
              </label>
              {errors.consent && (
        ...
        {/* Visit Jhamtani SpaceBiz & Logo Section */}
          ...
          <div className="flex flex-col text-left space-y-6 max-w-xl w-full">
            ...
            <div className="space-y-3 font-sans text-sm text-zinc-700 leading-relaxed font-light">
              <p>
                ...
                266/1/3/B, Baner Road,
Kalpana Nagar, Pashan,
Pune – 411045
              </p>
              <p>
            ...
            <div className="flex items-start gap-4 pt-2">
              <img
                src="/assets/jhamtani-spacebiz/rera.webp"
              ...
              <div className="flex flex-col space-y-1 mt-5">
                <div className="flex items-center gap-2">
                  ...
                  />
                  <span className="font-sans font-bold text-[18px] sm:text-[30px] text-zinc-950 tracking-wide leading-none">
                    P52100054460
                  </span>
                </div>
                <a
          ...
          <div className="shrink-0 flex items-center justify-center md:justify-center w-full md:w-auto mt-4 md:mt-0">
            <img
              ...
              className="w-auto h-20 sm:h-24 md:h-28 object-contain mix-blend-multiply"
            />
          </div>
        </div>
      </div>
          ...
          >
            ...
            >
              ...
              <p className="font-sans text-sm text-zinc-400 leading-relaxed font-light mb-6">
                Thank you for your interest in Jhamtani SpaceBiz. Our dedicated commercial property specialist will get in touch with you shortly.
              </p>
